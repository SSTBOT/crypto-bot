...
def save_history(history):
    with open(HISTORY_FILE, 'w') as f:
        json.dump(history[-100:], f, indent=2)  # Храним последние 100 сделок
...
def cmd_start(update, context):
    update.message.reply_text(
        ...
        "📜 История сделок показывает все твои + и -\n\n"
...
def main():
    ...
    print("📜 Все сделки сохраняются в историю\n")
